...
namespace Assignment_3_SWE30003.Migrations
{
    ...
    [Migration("20251103045340_FixSnapshot")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment_3_SWE30003.Models.InventoryProduct", b =>
                {
                    b.HasOne("Assignment_3_SWE30003.Models.Product", "Product")
                        .WithOne()
                        .HasForeignKey("Assignment_3_SWE30003.Models.InventoryProduct", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Assignment_3_SWE30003.Models.Invoice", b =>
                {
                    b.HasOne("Assignment_3_SWE30003.Models.Payment", "Payment")
                        .WithOne("Invoice")
                        .HasForeignKey("Assignment_3_SWE30003.Models.Invoice", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Assignment_3_SWE30003.Models.Payment", b =>
                {
                    b.HasOne("Assignment_3_SWE30003.Models.Order", "Order")
                        .WithOne()
                        .HasForeignKey("Assignment_3_SWE30003.Models.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Assignment_3_SWE30003.Models.Shipment", b =>
                {
                    b.HasOne("Assignment_3_SWE30003.Models.Order", "Order")
                        .WithOne("Shipment")
                        .HasForeignKey("Assignment_3_SWE30003.Models.Shipment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
