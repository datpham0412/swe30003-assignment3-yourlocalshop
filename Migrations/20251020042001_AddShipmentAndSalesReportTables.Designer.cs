...
namespace Assignment_3_SWE30003.Migrations
{
    ...
    [Migration("20251020042001_AddShipmentAndSalesReportTables")]
    partial class AddShipmentAndSalesReportTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Assignment_3_SWE30003.Models.Invoice", b =>
                {
                    b.HasOne("Assignment_3_SWE30003.Models.Order", "Order")
                        .WithOne()
                        .HasForeignKey("Assignment_3_SWE30003.Models.Invoice", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
