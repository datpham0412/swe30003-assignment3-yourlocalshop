...
// Admin navigation bar with dropdown menu for managing payments, orders, invoices, and shipments.
export function AdminNav({ onCreateClick }: { onCreateClick?: () => void }) {
  const router = useRouter();
  const pathname = usePathname();
  const [menuOpen, setMenuOpen] = useState(false);

  // Logs out admin by clearing credentials and redirecting to authentication page.
  const handleLogout = () => {
  ...
  // Opens user creation interface, either via callback or by navigating to the create user page.
